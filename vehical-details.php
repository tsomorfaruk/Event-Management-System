    ...
    <div class="listing_detail_head row">
      ...
      <div class="col-md-3">
        <div class="price_info">
          <p>BDT<?php $price = htmlentities($result->PricePerDay);
        ...
        <div class="listing_more_info">
          <div class="listing_detail_wrap"> 
            ...
            <ul class="nav nav-tabs gray-bg" role="tablist">
              <li role="presentation" class="active"><a href="#vehicle-overview " aria-controls="vehicle-overview" role="tab" data-toggle="tab">Performer Overview </a></li>
          
              <li role="presentation"><a href="#accessories" aria-controls="accessories" role="tab" data-toggle="tab">Performer's Skill</a></li>
            </ul>
            ...
            <div class="tab-content"> 
              ...
              <div role="tabpanel" class="tab-pane" id="accessories"> 
                ...
                <table>
                  <thead>
                    <tr>
                      <th colspan="2">Performer's Skill</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
        ...
        <div class="col-md-3 grid_listing">
          <div class="product-listing-m gray-bg">
            ...
            <div class="product-listing-content">
             ...
             <li><i class="fa fa-user" aria-hidden="true"></i><?php echo htmlentities($result->SeatingCapacity);?> performed</li>
                <li><i class="fa fa-calendar" aria-hidden="true"></i><?php echo htmlentities($result->ModelYear);?> reg. no</li>
