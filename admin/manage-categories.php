...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    <head>
        ...
        <title>Event management Portal |Admin Manage Category </title>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">Listed Category
                            <h5><span><?php
                                    ...
                                    if ($query->rowCount() > 0) {
                                        foreach ($results as $result) { ?>
                                            <tr>
                                                ...
                                                <td><a href="edit-category.php?id=<?php echo $result->CategoryId; ?>"><i
                                                                class="fa fa-edit"></i></a>&nbsp;&nbsp;
                                                    <a href="manage-categories.php?del=<?php echo $result->CategoryId; ?>"
