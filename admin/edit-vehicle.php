                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form method="post" class="form-horizontal" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">Performer Overview<span
                                                            style="color:red">*</span></label>
                                                <div class="col-sm-10">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label class="col-sm-2 control-label">Performed<span
                                                            style="color:red">*</span></label>
                                                <div class="col-sm-4">
                                                        ...
                                                        <div class="col-sm-3">
                                                            <?php if ($result->DriverAirbag == 1) {
                                                                ...
                                                                <div class="checkbox checkbox-inline">
                                                                    ...
                                                                    <label for="inlineCheckbox3"> Stage Magic
                                                                        Show </label>
                                                                </div>
                                                            <?php } else { ?>
                                                                <div class="checkbox checkbox-inline">
                                                            ...
                                                            <div class="col-sm-3">
                                                                <?php if ($result->CDPlayer == 1) {
                                                                    ...
                                                                    <div class="checkbox checkbox-inline">
                                                                        ...
                                                                        <label for="inlineCheckbox1"> Local
                                                                            Dancing </label>
                                                                    </div>
                                                                <?php } else { ?>
                                                                    <div class="checkbox checkbox-inline">
                                                            ...
                                                            <div class="col-sm-3">
                                                                <?php if ($result->CrashSensor == 1) {
                                                                    ...
                                                                    <div class="checkbox checkbox-inline">
                                                                        ...
                                                                        <label for="inlineCheckbox3"> Stage
                                                                            drama </label>
                                                                    </div>
                                                                <?php } else { ?>
                                                                    <div class="checkbox checkbox-inline">
