...
<label class="col-sm-2 control-label">Performer Name<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 control-label">Performer Overview<span style="color:red">*</span></label>
<div class="col-sm-10">
...
<option value="Petrol">Dhaka</option>
<option value="Diesel">Chittgong</option>
<option value="CNG">Sylhet</option>
</select>
</div>
</div>
...
<label class="col-sm-2 control-label">Performed<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<div class="col-md-12">
<div class="panel panel-default">
<div class="panel-heading">Performer's Skill</div>
<div class="panel-body">
...
<label for="inlineCheckbox1"> Folk Music </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox2"> Single band </label>
</div>
<?php } else {?>
...
<label for="inlineCheckbox3"> Wedding Photography </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox3"> Wild life Photography </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox1"> Reality Show </label>
</div>
<?php } else {?>
<div class="col-sm-3">
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox2">Instant Comedy</label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox3"> Stage Magic Show </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox3"> Stage Dancer </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox1"> Local Dancing </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox2">Guitarist</label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-success checkbox-inline">
...
<label for="inlineCheckbox3"> Piano </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox3"> Stage drama </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
